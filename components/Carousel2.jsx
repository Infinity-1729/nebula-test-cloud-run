// import style={{backgroundImage:'url(/slide-1.jpg)'}}s'
...
export default function Carousel2() {
    ...
    return (
        <>
            <div className='demo-3' style={{ scrollSnapAlign: snap }}>
                <main>
                    <div className="slideshow">
                        <div className="slides">
                            <div className="slide slide--current">
                                <div className="slide__img" style={{ backgroundImage: 'url(/slide-1.jpg)' }}></div>
                                <h2 className="slide__title">Dazzling</h2>
                                <p className="slide__desc">The main challenge is finding the right balance.</p>
                                <a className="slide__link" href="#">Discover more</a>
                            </div>
                            <div className="slide">
                                <div className="slide__img" style={{ backgroundImage: 'url(/slide-2.jpg)' }}></div>
                                <h2 className="slide__title">Brilliant</h2>
                                <p className="slide__desc">Put the right minds together and imagine infinity.</p>
                                <a className="slide__link" href="#">Find inspiration</a>
                            </div>
                            <div className="slide">
                                <div className="slide__img" style={{ backgroundImage: 'url(/slide-3.jpg)' }}></div>
                                <h2 className="slide__title">Sensational</h2>
                                <p className="slide__desc">Extremes are easy. Strive for balance.</p>
                                <a className="slide__link" href="#">Find out more</a>
                            </div>
                            <div className="slide">
                                <div className="slide__img" style={{ backgroundImage: 'url(/slide-4.jpg)' }}></div>
                                <h2 className="slide__title">Vibrant</h2>
                                <p className="slide__desc">The purest minds are those which love color the most.</p>
                                <a className="slide__link" href="#">Paint your future</a>
                            </div>
                        </div>
